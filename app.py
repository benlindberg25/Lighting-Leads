...
st.markdown("""
<style>
/* ââ Base & Background âââââââââââââââââââââââââââââââââââ */
.stApp {
...
/* ââ Property Cards âââââââââââââââââââââââââââââââââââââ */
.property-card {
    background: #1c2132;
    border: 1px solid #2a3040;
    border-radius: 12px;
...
/* ââ Photo Labels âââââââââââââââââââââââââââââââââââââââ */
.photo-label {
    text-align: center;
    font-size: 12px;
    font-weight: 600;
...
/* ââ Log output âââââââââââââââââââââââââââââââââââââââââ */
.stCode, code, pre {
...
/* ââ Inputs & Sliders âââââââââââââââââââââââââââââââââââ */
...
/* ââ Alert/Info boxes âââââââââââââââââââââââââââââââââââ */
.stAlert {
    background: #1c2132 !important;
    border: 1px solid #2a3040 !important;
    border-radius: 8px !important;
...
with st.sidebar:
    ...
    if not st.session_state.running:
        ...
        st.button("â¹  Stop", use_container_width=True, type="secondary",
                  on_click=lambda: (
...
<div style='padding: 8px 0 24px 0;'>
    ...
    <p style='color:#8b949e; font-size:15px; margin:6px 0 0 0;'>
        Northern Nassau County &amp; Suffolk County, NY â Homes sold $1.3M+ in the last 2 years
    </p>
</div>
""", unsafe_allow_html=True)
...
with tab_gallery:
    ...
    if not folders:
        ...
        for folder in filtered:
            ...
            # Card header
            meta_parts = []
            if beds and beds != "NA":   meta_parts.append(f"ðo  {beds} bd")
            if baths and baths != "NA": meta_parts.append(f"ð¿  {baths} ba")
            if sqft and sqft != "NA":   meta_parts.append(f"ð  {sqft} sq ft")
            ...
            zillow_link = (f"<a href='{zillow_url}' target='_blank' "
                           f"style='color:#f0b429; font-size:12px;'>View on Zillow â</a>"
            ...
            <div class='property-card'>
                <div class='property-card-header'>
                    ...
                    <div class='property-meta'>
                        {meta_html}
                        {("Â· " + zillow_link) if zillow_link else ""}
                    </div>
                </div>
            </div>
            """, unsafe_allow_html=True)
            ...
            with col1:
                st.markdown("<p class='photo-label label-before'>ð· Original Photo</p>",
                            unsafe_allow_html=True)
                if orig_path.exists():
            ...
            with col2:
                st.markdown("<p class='photo-label label-after'>ð¡ With Landscape Lighting (AI)</p>",
                            unsafe_allow_html=True)
                if render_path.exists():
                    ...
                    st.markdown(
                        "<div style='background:#1c2132; height:200px; border-radius:8px; "
                        "display:flex; align-items:center; justify-content:center; "
                        "color:#4a5568; border: 1px dashed #2a3040;'>â³ Rendering pending</div>",
                        unsafe_allow_html=True
                    )
...
st.markdown(
    ...
    "ð¡ Landscape Lighting Lead Generator â¢ "
    "Northern Nassau &amp; Suffolk County, NY â¢ "
